...
var ColoredLed = function (_a) {
    var color = _a.color;
    var baseColor = color_1.default(color);
    var hslLDivTwo = baseColor.darken(0.5);
    var hslSMinus6 = baseColor.desaturate(0.06);
    var centerId = "center-" + baseColor.rgbNumber();
    var reflectId = "reflect-" + baseColor.rgbNumber();
